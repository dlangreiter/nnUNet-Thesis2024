...
DATASET_DIR = '/home/declan/MultiModalModel/0001(95)'  

# Path to the nnU-Net raw dataset directory
NNUNET_RAW_DIR = '/home/declan/MultiModalModel/nnUNet_raw'  

# Unique Dataset ID and Name
DATASET_ID = 100  
DATASET_NAME = 'Liver'
FILE_ENDING = '.nii.gz'
DLDS_MAPPING_CSV = '/home/declan/MultiModalModel/patient_dlss.csv'  
...
def main():
    ...
    for idx, patient_id in enumerate(ELIGIBLE_PATIENTS, start=1):
        ...
        for series_folder in series_folders:
            ...
            if image:
                modalities[label] = temp_image_path 
